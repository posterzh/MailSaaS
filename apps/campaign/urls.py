...
urlpatterns = [
    ...
    path('settings-leadcatcher/', views.CampaignleadCatcherView.as_view(),name = 'campaignleadcatcher'),
    path('settings-leadcatcherview/', views.LeadCatcherUpdateView.as_view(),name = 'campaignleadcatcher'),
