...
urlpatterns = [
    ...
    path('get-overview/<int:pk>/',views.GetCampaignOverview.as_view(),name = 'Get_campaign_overview'),
    ...
    path('campaign-leadcatcher/', views.CampaignleadCatcherView.as_view(),name = 'campaignleadcatcher'),
    path('campaign-leadcatcherview/', views.LeadCatcherUpdateView.as_view(),name = 'campaignleadcatcher'),
    path('campaign-message/<int:pk>/', views.CampaignMessages.as_view(),name = 'campaignmessage'),
