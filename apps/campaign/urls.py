...
urlpatterns = [
    ...
    path('prospects/detail/', views.ProspectsDetailView.as_view(), name='procpects_detail'),
    ...
    path('delete/<int:pk>/', views.CampaignDeleteView.as_view(), name='delete_campaign'),
    path('sequence-update/', views.CampaignSequenceUpdateView.as_view(), name='sequence-update'),
