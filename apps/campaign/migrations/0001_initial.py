# Generated by Django 3.1.4 on 2021-03-06 01:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='mailaccounts.emailaccount')),
            ],
        ),
        migrations.CreateModel(
            name='FollowUpEmail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lead_status', models.CharField(choices=[('none', 'None'), ('openLead', 'Open Lead'), ('wonLead', 'Won Lead'), ('lostLead', 'Lost Lead'), ('ignoredLead', 'Ignored Lead'), ('forwardedLead', 'Forwarded Lead')], default='none', max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('leadcatcher_recipient', models.CharField(choices=[('replies', 'Replies'), ('open', 'Open'), ('click_any_link', 'Clicks any link'), ('clicks_specific_link', 'Clicks specific link')], default='replies', max_length=32)),
        ...
        migrations.AddField(
            model_name='campaign',
            name='label_name',
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.SET_DEFAULT, to='campaign.campaignlabel'),
        ),
    ]
