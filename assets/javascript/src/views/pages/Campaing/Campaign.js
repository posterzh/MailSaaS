        ...
        <div className="main-view">
          ...
          <Container fluid className="">
            <Row>
              ...
              <Col md={1}>
                <div>
                  <label className="filter_app">Teammate</label>
                  <br></br>
            ...
            <Row className="mt-4">
              {show && (
                <Col md={1} style={{ height: "40px" }}>
                  <div className="campaign_label">
                    <div
                      className="add_label"
                      onClick={(e) => {
                        e.preventDefault(), this.setState({ show: !show });
                      }}
                    >
                      {" "}
                      <span>+ Label</span>
                ...
                <Col md={3}>
                  <div className="grand_parent">
                    <div className="input_field">
                      <Input
                        type="email"
                        className="label_input w-100"
                        placeholder="Create a campaign label"
                      />
                      <div className="child mt-2">
                        <a
                          href=""
                          onClick={(e) => {
                            e.preventDefault(), this.setState({ show: true });
                          }}
                        >
                ...
                <div className="campaign_label">
                  <div className="add_label">
                    ...
                    <span>
                      ...
                      <span style={{ fontSize: "1em" }}>Unlabeled</span>
                    </span>
                  </div>
                </div>
              </Col>
              <Col md={1}>
                <div className="campaign_label">
                  <div
                    className="add_label"
                    onMouseOut={(e) => {
                      e.preventDefault(), this.setState({ hide: hide });
                    }}
                    onMouseMove={(e) => {
                      e.preventDefault(), this.setState({ hide: !hide });
                    }}
                  >
                    <span>
                      <i className="fa fa-tags" aria-hidden="true"></i>testlabel
                      <span></span>
                    </span>
                  </div>
                </div>
              ...
              <Row>
                <Col md={12}>
                  <Table responsive hover style={{ textAlign: "center" }}>
                    ...
                    <tbody>
                      {Tables &&
                        Tables.CampaignTableData.map((item, index) => {
                          return (
                            <>
                              <tr key={index} className="pointer">
                                ...
                                <td
                                  onClick={() => {
                                    this.props.CampaignOverviewAction(item.id);
                                  }}
                                ...
                                <td
                                  ...
                                  className="Created"
                                >
                                  {item.camp_created_date_time
                                    .slice(0, 3)
                                    .concat(
                                      item.camp_created_date_time.slice(-3)
                                    )}
                                </td>
                                <td
                                  onClick={() => {
          ...
          <div
            ...
            style={{ position: "fixed", bottom: 0, right: 5 }}
          >
