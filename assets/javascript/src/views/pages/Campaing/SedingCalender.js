...
export class SendingCalender extends Component {
  ...
  handleSubmit = (event) => {
    console.log('sending calender.js',kteams/eshavdata)
...
const mapStateToProps = (state) => {
  console.log("data+++++++++++++++++++++", state.ScheduleGetDataReducer.ScheduleGetData)
  console.log("cheeeeeeeeeeeeeeeeeeeeking",state.ScheduleUpdateReducer.UpdateScheduleData )
   return {
     ...
     UpdateScheduleData:state.ScheduleGetDataReducer.UpdateScheduleData
    } }
