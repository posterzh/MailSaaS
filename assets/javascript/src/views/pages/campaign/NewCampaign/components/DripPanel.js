      ...
      <Container fluid>
        <Row className="mt-3">
          <Col md={12} className="alignRight">
            ...
            {preview ? 
              <Row>
                <i className="fas fa-stopwatch" aria-hidden="true"></i><span>&nbsp;&nbsp;{this.getPlural(data.wait_days, 'day')} later</span>
              </Row>
              :
              <>
                <Row>
            ...
            <Row className="mt-0">
              <Input
                defaultValue={preview && replacement ? parseTemplate(data.email_subject, replacement) : data.email_subject}
                onChange={(e) => {
