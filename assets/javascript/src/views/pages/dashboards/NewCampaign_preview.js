...
import { Container, Row, Nav, Input, Col, Button } from "reactstrap";
          ...
          <Container fluid>
              ...
              <Col style={{ display: "flex" }}>
                <Nav className="mx-auto" navbar>
                  <Row className="mx-auto" style={{ width: "100%" }}>
                    <NewCampaignHeader active="PREVIEW" />
                  </Row>
                </Nav>
              </Col>
            </Row>
            <Row className="mt-3">
              <Col md={6} className="mx-auto">
                <Row className="preview_email">
                  Preview and personalize each email
                </Row>
                <Row className="beforehitting_next">
                  Before hitting next, make sure:
                </Row>
                <Row style={{ display: "flex", justifyContent: "center" }}>
                  <Row className="condition_container">
                    <Row>
                      <div style={{ display: "flex", flexDirection: "row" }}>
                        <div className="rightcheck_icon">
                          <i
                              ...
                              return (
                                <div>
                                  <Col md={11} className="alignRight">
                                    ...
                                    <Row>
                                      <p style={{ fontSize: "14px" }}>
                                        Unlike follow-ups, drips keep sending
                                        even after a recipient becomes a lead.
                                        <a href="">
                                          Learn how to customize Lead Catcher.
                                        </a>
                                      </p>
