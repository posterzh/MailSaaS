...
class CampaignPreview extends Component {
    ...
    componentDidMount() {
        this.props.PreviewCampaignAction(this.props.campaignId);
        console.log("in js file  PreviewCampaignAction", this.props.campaignId)
    }
    render() {
...
const mapStateToProps = (state) => {
    // console.log("state===>",state.StartCampaign.ReducerstartCampaignData)
...
const mapDispatchToProps = dispatch => ({
    PreviewCampaignAction: (campaignId,props) => { dispatch(PreviewCampaignAction(campaignId,props)) },
