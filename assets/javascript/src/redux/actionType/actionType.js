...
// MailAccounts
export const GET_MAILACCOUNTSS = "GET_NOTES";
export const ADD_MAILACCOUNT = "ADD_NOTE";
export const DELETE_MAILACCOUNT = "DELETE_NOTE";
export const UPDATE_MAILACCOUNT = "UPDATE_NOTE";
